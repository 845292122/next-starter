          ...
          <CardHeader className="justify-between">
            <div className="flex gap-3">
              ...
              <div className="flex flex-col items-start justify-center">
                ...
                <h5 className="text-small text-default-500 tracking-tight">@zoeylang</h5>
              </div>
            </div>
          ...
          <CardBody className="px-3 py-0">
            <div className="grid grid-cols-2 gap-2">
              <div className="flex gap-2">
                ...
                <p className="text-default-600 text-small truncate font-semibold">幻影旅团</p>
              </div>
              <div className="flex gap-2">
                <p className="text-default-500 text-small w-11 shrink-0">联系人</p>
                <p className="text-default-600 text-small truncate font-semibold">库洛洛</p>
              </div>
              <div className="col-span-2 flex gap-2">
                <p className="text-default-500 text-small w-10 shrink-0">邮 箱</p>
                <p className="text-default-600 text-small truncate font-semibold">
                  12312323@qq.com
                </p>
              </div>
              <div className="col-span-2 flex gap-2">
                <p className="text-default-500 text-small w-10 shrink-0">电 话</p>
                <p className="text-default-600 text-small truncate font-semibold">13212341234</p>
              </div>
            </div>
            <div className="flex gap-2">
              <Button
